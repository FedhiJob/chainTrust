...
export default function AdminDashboardPage() {
  ...
  const cards = useMemo(() => {
    ...
    return [
      ...
      { label: "Total transfers", value: data.totalTransfers },
    ];
  }, [data]);
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 px-6 py-12">
      <header className="space-y-2 fade-up">
        ...
        <h1 className="text-3xl font-semibold">System oversight</h1>
        <p className="text-muted">Visibility into users, batches, and transfers across ChainTrust.</p>
      </header>
